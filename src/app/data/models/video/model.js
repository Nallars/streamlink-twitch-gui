...
export default Model.extend({
	/** @property {TwitchVideos} video */
	video: belongsTo( "twitchVideos", { async: false } ),
	...
	streamUrl: computed( "video.url", function() {
		const url = get( this, "video.url" );
		return url;
	}),
